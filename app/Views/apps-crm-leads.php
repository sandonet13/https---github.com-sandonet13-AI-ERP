...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Leads')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'CRM', 'title' => 'Leads')); ?>
                                    ...
                                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                                        ...
                                        <form action="" class="d-flex flex-column justify-content-end h-100">
                                            <div class="offcanvas-body">
                                                <div class="mb-4">
                                                    <label for="datepicker-range" class="form-label text-muted text-uppercase fw-bold fs-13 mb-3">Date</label>
                                                    <input type="date" class="form-control" id="datepicker-range" data-provider="flatpickr" data-range="true" placeholder="Select date">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="country-select" class="form-label text-muted text-uppercase fw-bold fs-13 mb-3">Country</label>
                                                ...
                                                <div class="mb-4">
                                                    <label for="status-select" class="form-label text-muted text-uppercase fw-bold fs-13 mb-3">Status</label>
                                                    <div class="row g-2">
                                                        <div class="col-lg-6">
                                                            <div class="form-check">
                                                ...
                                                <div class="mb-4">
                                                    <label for="leadscore" class="form-label text-muted text-uppercase fw-bold fs-13 mb-3">Lead Score</label>
                                                ...
                                                <div>
                                                    <label for="leads-tags" class="form-label text-muted text-uppercase fw-bold fs-13 mb-3">Tags</label>
                                                    <div class="row g-3">
                                                        <div class="col-lg-6">
                                                            <div class="form-check">
