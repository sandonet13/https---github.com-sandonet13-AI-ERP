...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Buy & Sell')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Crypto', 'title' => 'Buy & Sell')); ?>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h2 class="mb-0">$<span class="counter-value" data-target="243"></span><small class="text-muted fs-14">.10k</small></h2>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h2 class="mb-0">$<span class="counter-value" data-target="658"></span><small class="text-muted fs-14">.00k</small></h2>
                                        </div>
                                        <div class="flex-shrink-0 avatar-sm">
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h2 class="mb-0">$<span class="counter-value" data-target="104"></span><small class="text-muted fs-14">.85k</small></h2>
                                        </div>
                                        <div class="flex-shrink-0 avatar-sm">
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h2 class="mb-0">$<span class="counter-value" data-target="87"></span><small class="text-muted fs-14">.35k</small></h2>
                                        </div>
                                        <div class="flex-shrink-0 avatar-sm">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-6">
                                                <div class="d-flex flex-wrap gap-4 align-items-center">
                                                    <div>
                                                        <h3 class="fs-20">$46,959.<small class="fs-15 text-muted">00</small></h3>
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">Transaction Fees<span class="text-muted ms-1 fs-12">(0.05%)</span></p>
                                                        </div>
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">Minimum Received<span class="text-muted ms-1 fs-12">(2%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="tab-pane" id="cryptoSell" role="tabpanel">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="fs-14 mb-0">Transaction Fees<span class="text-muted ms-1 fs-12">(0.05%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                            <h6 class="mb-0">$1.08</h6>
                                                        </div>
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="fs-14 mb-0">Minimum Received<span class="text-muted ms-1 fs-12">(2%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                            <h6 class="mb-0">$7.85</h6>
                                                        </div>
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            ...
                                            <td class="valume">
                                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.50%</h6>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="valume">
                                                <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.42%</h6>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="market_cap">$314,520,675</td>
                                            <td class="valume">
                                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.89%</h6>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="valume">
                                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.92%</h6>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="valume">
                                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.96%</h6>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="valume">
                                                <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>0.84%</h6>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="market_cap">$156,209,195.18</td>
                                            <td class="valume">
                                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>8.20%</h6>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="market_cap">$880,387,980.14</td>
                                            <td class="valume">
                                                <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>1.03%</h6>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-soft-info">Trade Now</button>
                                            </td>
