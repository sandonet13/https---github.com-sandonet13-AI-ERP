...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Transactions')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Crypto', 'title' => 'Transactions')); ?>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-2">$<span class="counter-value" data-target="74858">0</span><small class="text-muted fs-14">.68k</small></h3>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-2">$<span class="counter-value" data-target="74361">0</span><small class="text-muted fs-14">.34k</small></h3>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-2">$<span class="counter-value" data-target="97685">0</span><small class="text-muted fs-14">.22k</small></h3>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card card-animate">
                                            <div class="card-body bg-soft-warning">
                                                ...
                                                <h3 class="mb-2">$245<small class="text-muted fs-14">.65k</small></h3>
