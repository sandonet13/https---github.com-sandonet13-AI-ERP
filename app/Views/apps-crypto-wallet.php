...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'My Wallet')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Crypto', 'title' => 'My Wallet')); ?>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+0.63%<span class="text-muted ms-2 fs-12">(BTC)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fw-medium mb-0">-3.42%<span class="text-muted ms-2 fs-12">(LTC)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h6 class="ms-2 mb-0 fs-15">Ethereum</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$3,748.66</h5>
                                                        <p class="text-danger fw-medium mb-0">+0.42%<span class="text-muted ms-2 fs-12">(ETH)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h6 class="ms-2 mb-0 fs-15">Monero</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$226.55</h5>
                                                        <p class="text-danger fw-medium mb-0">-1.92%<span class="text-muted ms-2 fs-12">(XMR)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">+16.38%<span class="text-muted ms-2 fs-12">(DASH)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <h6 class="ms-2 mb-0 fs-15">Maker</h6>
                                                </div>
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        <h5 class="mb-1 mt-4">$2,390.75</h5>
                                                        <p class="text-success fw-medium mb-0">+0.36%<span class="text-muted ms-2 fs-12">(MKR)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-medium mb-0">32.07%<span class="text-muted ms-2 fs-12">(NEO)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                        ...
                        <div class="col-xxl-3">
                                ...
                                <div class="card-body bg-soft-warning">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h2>$61,91,967<small class="text-muted fs-15">.29</small></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <h5 class="fs-14 mb-3">Today's Profit</h5>
                                            <h2>$2,74,365<small class="text-muted fs-15">.84</small></h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <h5 class="fs-14 mb-3">Overall Profit</h5>
                                            <h2>$32,67,120<small class="text-muted fs-15">.42</small></h2>
