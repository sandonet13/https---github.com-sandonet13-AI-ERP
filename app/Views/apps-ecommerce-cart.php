...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Shopping Cart')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Ecommerce', 'title' => 'Shopping Cart')); ?>
                            ...
                            <div class="card product">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-sm">
                                            <h5 class="fs-15 text-truncate"><a href="ecommerce-product-detail"
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="text-lg-end">
                                                ...
                                                <h5 class="fs-15">$<span id="ticket_price"
