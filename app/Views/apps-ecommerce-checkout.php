...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Checkout')); ?>
        ...
        <div class="main-content overflow-hidden">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Ecommerce', 'title' => 'Checkout')); ?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="pills-bill-address" role="tabpanel" aria-labelledby="pills-bill-address-tab">
                                                ...
                                                <div class="mt-4">
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div class="form-check card-radio">
                                                                ...
                                                                <label class="form-check-label" for="shippingAddress01">
                                                                    <span class="mb-4 fw-bold d-block text-muted text-uppercase">Home Address</span>

                                                                    <span class="fs-15 mb-2 d-block">Marcus Alfaro</span>
                                                        ...
                                                        <div class="col-lg-4 col-sm-6">
                                                            <div class="form-check card-radio">
                                                                ...
                                                                <label class="form-check-label" for="shippingAddress02">
                                                                    <span class="mb-4 fw-bold d-block text-muted text-uppercase">Office Address</span>
                                                    ...
                                                    <div class="mt-4">
                                                        <h5 class="fs-15 mb-3">Shipping Method</h5>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-check card-radio">
                                                                    ...
                                                                    <label class="form-check-label" for="shippingMethod01">
                                                                        <span class="fs-20 float-end mt-2 text-wrap d-block fw-bold">Free</span>
                                                                        <span class="fs-15 mb-1 text-wrap d-block">Free Delivery</span>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-check card-radio">
                                                                    ...
                                                                    <label class="form-check-label" for="shippingMethod02">
                                                                        <span class="fs-20 float-end mt-2 text-wrap d-block fw-bold">$24.99</span>
                                                                        <span class="fs-15 mb-1 text-wrap d-block">Express Delivery</span>
                                            ...
                                            <div class="tab-pane fade" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                                                <div class="text-center py-5">
                                                    ...
                                                    <h3 class="fw-semibold">Order ID: <a href="apps-ecommerce-order-details" class="text-decoration-underline">VZ2451</a></h3>
                                                </div>
                                            </div>
                                            <!-- end tab pane -->
                                        </div>
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-15"><a href="apps-ecommerce-product-details" class="text-dark">Sweatshirt for Men (Pink)</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-15"><a href="apps-ecommerce-product-details" class="text-dark">Noise Evolve Smartwatch</a></h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h5 class="fs-15"><a href="apps-ecommerce-product-details" class="text-dark">350 ml Glass Grocery Container</a></h5>
