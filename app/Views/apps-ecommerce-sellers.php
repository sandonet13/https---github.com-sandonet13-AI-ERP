                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-lg-auto">
                                    <div class="hstack gap-2">
                                        <button type="button" class="btn btn-secondary"><i class="ri-equalizer-fill me-1 align-bottom"></i> Filters</button>
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#addSeller"><i class="ri-add-fill me-1 align-bottom"></i> Add Seller</button>
                                    </div>
                                </div>
                                <!--end col-->
                            </div>
