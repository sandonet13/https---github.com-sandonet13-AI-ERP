...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Invoice Action')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Email', 'title' => 'Ecommerce Action')); ?>
                                                                ...
                                                                <tbody>
                                                                    <tr style="text-align: left;">
                                                                        <th style="padding: 5px;width: 110px;">
                                                                            <img src="/assets/images/products/img-3.png" alt="" height="80">
                                                                        </th>
                                                                        <th style="padding: 5px;">
                                                                    ...
                                                                    <tr style="text-align: left;">
                                                                        <th style="padding: 5px;width: 110px;">
                                                                            <img src="/assets/images/products/img-2.png" alt="" height="80">
                                                                        </th>
                                                                        <th style="padding: 5px;">
                                                                    ...
                                                                    <tr style="text-align: left;">
                                                                        <th style="padding: 5px;width: 110px;">
                                                                            <img src="/assets/images/products/img-1.png" alt="" height="80">
                                                                        </th>
                                                                        <th style="padding: 5px;">
