...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Live Auction')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'NFT Marketplace', 'title' => 'Live Auction')); ?>
                        ...
                        <div class="col-xxl-9">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-lg-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <h5 class="card-title fw-bold mb-0">Live Auction</h5>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">Creative Filtered Portrait</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">Smillevers Crypto</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                                    <div class="card explore-box card-animate">
                                        <div class="position-relative rounded overflow-hidden">
                                            <img src="/assets/images/nft/gif/img-5.gif" alt="" class="card-img-top explore-img">
                                            <div class="discount-time">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">The Chirstoper</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a></h6>
                                            <div>
                                ...
                                <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                                    <div class="card explore-box card-animate">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                            <h6 class="fs-16 mb-3"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a></h6>
                                            <div>
                        ...
                        <div class="col-xxl-3">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h6 class="card-title fw-bold mb-0 flex-grow-1">Top Drop</h6>
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/gif/img-4.gif" alt="" class="avatar-sm object-cover rounded-circle">
                                                            <div class="ms-2">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/gif/img-3.gif" alt="" class="avatar-sm object-cover rounded-circle">
                                                            <div class="ms-2">
                            ...
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h6 class="card-title mb-0 fw-bold flex-grow-1">Top Creator</h6>
