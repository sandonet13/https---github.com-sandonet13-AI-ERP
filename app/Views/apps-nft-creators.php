...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Creators')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'NFT Marketplace', 'title' => 'Creators')); ?>
                    ...
                    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="/assets/images/users/avatar-2.jpg" alt="" class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                                    <a href="pages-profile">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="/assets/images/nft/gif/img-2.gif" alt="" class="object-cover card-img-top" height="120">
                                <div class="card-body text-center">
                                    <img src="/assets/images/users/avatar-6.jpg" alt="" class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                                    <a href="pages-profile">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="/assets/images/nft/img-06.jpg" alt="" class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                                    <a href="pages-profile">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="/assets/images/nft/gif/img-1.gif" alt="" class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                                    <a href="pages-profile">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="/assets/images/nft/gif/img-3.gif" alt="" class="object-cover card-img-top" height="120">
                                <div class="card-body text-center">
                                    <img src="/assets/images/users/avatar-8.jpg" alt="" class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                                    <a href="pages-profile">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="/assets/images/nft/gif/img-4.gif" alt="" class="object-cover card-img-top" height="120">
                                <div class="card-body text-center">
                                    <img src="/assets/images/users/avatar-10.jpg" alt="" class="avatar-md rounded-circle object-cover mt-n5 border border-5 border-white mx-auto d-block">
                                    <a href="pages-profile">
