...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Item Details')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Pages', 'title' => 'Item Details')); ?>
                                        ...
                                        <div class="card ribbon-box border shadow-none right">
                                            ...
                                            <div class="position-absolute bottom-0 p-3">
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-3">
                                                        <img src="/assets/images/nft/gif/img-3.gif" alt="" class="img-fluid rounded h-100 object-cover">
                                                    </div>
                                                    <div class="col-3">
                                ...
                                <div class="col-lg-8">
                                    <div>
                                        ...
                                        <div class="product-content mt-5">
                                            <h5 class="fs-14 fw-bold mb-3">Product Description :</h5>
                                            <nav>
                                                        ...
                                                        <table class="table align-middle table-nowrap mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="apps-nft-item-details" class="link-dark"><span class="mb-0 ms-2">Brave Tigers NFT</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>0.235 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="apps-nft-item-details" class="link-dark"><span class="mb-0 ms-2">Creative filtered portrait</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>571.24 ETH</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            <img src="/assets/images/nft/gif/img-4.gif" alt="" class="avatar-xs rounded object-cover" />
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <a href="apps-nft-item-details" class="link-dark"><span class="mb-0 ms-2">Robotic Body Art</span></a>
                                                                        </div>
                                                                    </th>
                                                                    <td>81.72 ETH</td>
                                                                    <td>
