...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Marketplace')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'NFT Marketplace', 'title' => 'Marketplace')); ?>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card explore-box">
                                <div class="card-body">
                                    ...
                                    <div class="explore-place-bid-img overflow-hidden rounded">
                                        <img src="/assets/images/nft/gif/img-3.gif" alt="" class="img-fluid explore-img">
                                        <div class="bg-overlay"></div>
                                        <div class="place-bid-btn">
                                            <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="link-dark">Creative Filtered Portrait</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">The Chirstoper</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">Trendy Fashion Portraits</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">Smillevers Crypto</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">Evolved Reality</a></h5>
                        ...
                        <div class="col">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a></h5>
                    ...
                    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="/assets/images/nft/gif/img-5.gif" alt="" class="card-img-top object-cover" height="120">
                                <div class="card-body text-center">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="/assets/images/nft/gif/img-2.gif" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <img src="/assets/images/nft/gif/img-1.gif" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
