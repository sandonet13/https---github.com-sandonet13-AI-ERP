...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Ranking')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'NFT Marketplace', 'title' => 'Ranking')); ?>
                                        ...
                                        <table class="table align-middle table-nowrap table-hover" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/img-01.jpg" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/gif/img-1.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/img-02.jpg" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Creative Filtered Portrait</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/gif/img-2.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Long-tailed Macaque</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/img-04.jpg" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/img-06.jpg" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Smillevers Crypto</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/gif/img-5.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">The Chirstoper</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/gif/img-3.gif" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Walking On Air</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/img-05.jpg" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">The Chirstoper</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/img-03.jpg" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Walking On Air</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="collection">
                                                        <div class="d-flex align-items-center">
                                                            <img src="/assets/images/nft/img-04.jpg" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Highstreet IHO Part</a>
                                                        </div>
                                                    </td>
