...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Project Overview')); ?>
                                                    ...
                                                    <div data-simplebar style="height: 300px;" class="px-3 mx-n3 mb-2">
                                                        <div class="d-flex mb-4">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-14">Joseph Parker <small class="text-muted ms-2">20 Dec 2021 - 05:47AM</small></h5>
                                                                ...
                                                                <div class="d-flex mt-4">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-3">
                                                                        <h5 class="fs-14">Alexis Clarke <small class="text-muted ms-2">22 Dec 2021 - 02:32PM</small></h5>
                                                        ...
                                                        <div class="d-flex mb-4">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-14">Donald Palmer <small class="text-muted ms-2">24 Dec 2021 - 05:20PM</small></h5>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-14">Alexis Clarke <small class="text-muted ms-2">26 min ago</small></h5>
                                                                ...
                                                                <div class="d-flex mt-4">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-3">
                                                                        <h5 class="fs-14">Donald Palmer <small class="text-muted ms-2">8 sec ago</small></h5>
