        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Tasks', 'title' => 'Task Details')); ?>
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <div class="hstack gap-2 justify-content-center">
                                        ...
                                        <button class="btn btn-secondary btn-sm"><i class="ri-play-circle-line align-bottom me-1"></i> Start</button>
                                    </div>
                                </div>
                            </div>
                            <!--end card-->
                                    ...
                                    <div class="vstack gap-2">
                                        ...
                                        <div class="border rounded border-dashed p-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h5 class="fs-15 mb-1"><a href="javascript:void(0);" class="text-body text-truncate d-block">Velzon admin.ppt</a></h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-muted">
                                        ...
                                        <h6 class="mb-3 fw-bold text-uppercase">Sub-tasks</h6>
                                        ...
                                        <div class="pt-3 border-top border-top-dashed mt-4">
                                            <h6 class="mb-3 fw-bold text-uppercase">Tasks Tags</h6>
                                            ...
                                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-15"><a href="pages-profile">Joseph Parker</a> <small class="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                                        ...
                                                        <div class="d-flex mt-4">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="pages-profile">Tonya Noble</a> <small class="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                                                ...
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-15"><a href="pages-profile">Thomas Taylor</a> <small class="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <h5 class="fs-15"><a href="pages-profile">Tonya Noble</a> <small class="text-muted">26 min ago</small></h5>
                                                        ...
                                                        <div class="d-flex mt-4">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <h5 class="fs-15"><a href="pages-profile">Nancy Martino</a> <small class="text-muted">8 sec ago</small></h5>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-2">
                                                                        <a href="pages-profile" class="fw-medium link-secondary">Thomas Taylor</a>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                            <td>02 Jan, 2022</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="flex-grow-1 ms-2">
                                                                        <a href="pages-profile" class="fw-medium link-secondary">Tonya Noble</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>28 Dec, 2021</td>
