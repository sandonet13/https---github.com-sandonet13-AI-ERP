        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Tasks', 'title' => 'Kanban Board')); ?>
                    ...
                    <div class="tasks-board mb-3" id="kanbanboard">
                                ...
                                <div id="unassigned-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Profile Page Satructure</a></h6>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <li><a class="dropdown-item" href="apps-tasks-details"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Velzon - Admin Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                ...
                                <div id="todo-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Admin Layout Design</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <div class="flex-grow-1">
                                                    <h6 class="fs-16 mb-0 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Marketing & Sales</a></h6>
                                                </div>
                                                <div class="flex-shrink-0">
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">Inprogress <small class="badge bg-warning align-bottom ms-1 totaltask-badge">2</small></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div id="inprogress-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Brand Logo Design</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Change Old App Icon</a></h6>
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">In Reviews <small class="badge bg-info align-bottom ms-1 totaltask-badge">3</small></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div id="reviews-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Create Product Animations</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Product Features Analysis</a></h6>
                                    ...
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details" class="d-block">Create a Graph of Sketch</a></h6>
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">Completed <small class="badge bg-success align-bottom ms-1 totaltask-badge">1</small></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                                <div id="completed-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            <div class="d-flex mb-2">
                                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Create a Blog Template UI</a></h6>
                                                <div class="dropdown">
                        ...
                        <div class="tasks-list">
                            <div class="d-flex mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fs-14 text-uppercase fw-bold mb-0">new <small class="badge bg-success align-bottom ms-1 totaltask-badge">1</small></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="dropdown card-header-dropdown">
                                        <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div id="new-task" class="tasks">
                                    <div class="card tasks-box">
                                        <div class="card-body">
                                            ...
                                            <h6 class="fs-16 text-truncate task-title"><a href="apps-tasks-details" class="link-dark d-block">Banner Design for FB & Twitter</a></h6>
