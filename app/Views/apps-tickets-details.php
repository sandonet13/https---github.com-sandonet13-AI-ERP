...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Ticket Details')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md">
                                                <div class="row align-items-center">
                                                    ...
                                                    <!--end col-->
                                                    <div class="col-md">
                                                        <h4 id="ticket-title">#VLZ135 - Create an Excellent UI for a Dashboard</h4>
                        ...
                        <div class="col-xxl-9">
                            <div class="card">
                                <div class="card-body p-4">
                                    <h6 class="fw-bold text-uppercase mb-3">Ticket Discripation</h6>
                                    ...
                                    <h6 class="fw-bold text-uppercase mb-3">Create an Excellent UI for a Dashboard</h6>
                                    ...
                                    <div class="mt-4">
                                        <h6 class="fw-bold text-uppercase mb-3">Here is the code you've requsted</h6>
                                        <div>
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="hstack text-wrap gap-1 fs-15">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center border border-dashed p-2 rounded">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1 fs-15"><a href="javascript:void(0);">Velzon-admin.zip</a></h6>
                                            <span class="text-muted">3.2 MB</span>
                                        </div>
                                    ...
                                    <div class="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1 fs-15"><a href="javascript:void(0);">Velzon-admin.ppt</a></h6>
                                            <span class="text-muted">4.5 MB</span>
                                        </div>
                                        <div class="hstack gap-3 fs-16">
                                            <a href="javascript:void(0);" class="text-muted"><i class="ri-download-2-line"></i></a>
                                            <a href="javascript:void(0);" class="text-muted"><i class="ri-delete-bin-line"></i></a>
