                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="text-muted text-center mx-lg-3">
                                            ...
                                            <p>Please enter the 4 digit code sent to <span class="fw-bold">example@abc.com</span></p>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control form-control-lg bg-light border-light text-center" onkeyup="moveToNext(this, 4)" maxLength="1" id="digit4-input">
                                                        </div>
                                                    </div><!-- end col -->
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Didn't receive a code ? <a href="auth-pass-reset-cover" class="fw-bold text-primary text-decoration-underline">Resend</a> </p>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col -->
