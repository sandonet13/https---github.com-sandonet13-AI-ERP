                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <p class="text-uppercase fw-bold fs-13 text-muted mb-1">Total Invested</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <p class="text-uppercase fw-bold fs-13 text-muted mb-1">Total Change</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <p class="text-uppercase fw-bold fs-13 text-muted mb-1">Day Change</p>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-6">
                                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                                ...
                                                                <p class="fw-semibold text-muted mb-0">$75.69 <span class="text-success fs-13 ms-1">+1.99%</span></p>
                                                                <p class="fw-semibold text-muted mb-0">High <span class="text-dark fs-13 ms-1">0.014578</span></p>
                                                                <p class="fw-semibold text-muted mb-0">Low <span class="text-dark fs-13 ms-1">0.0175489</span></p>
                                                            </div>
                                                        </div><!-- end col -->
                                                        <div class="col-6">
                                                            <div class="d-flex">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-semibold mb-0">+13.11%<span class="text-muted ms-2 fs-13 text-uppercase">(btc)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fs-14 fw-semibold mb-0">+15.08%<span class="text-muted ms-2 fs-10 text-uppercase">(ltc)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                                        <div class="apex-charts crypto-widget" data-colors='["--vz-success", "--vz-transparent"]' id="litecoin_sparkline_charts" dir="ltr"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row -->
                                            </div><!-- end card body -->
                                        </div><!-- end card -->
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="float-end">
                                                    <div class="dropdown">
                                                        <a class="text-reset" href="#" data-bs-toggle="dropdown" <span class="text-muted fs-18"><i class="mdi mdi-dots-horizontal"></i></span></a>
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="#">Details</a>
                                                            <a class="dropdown-item" href="#">Cancel</a>
                                                        </div>
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-semibold mb-0">+08.57%<span class="text-muted ms-2 fs-13 text-uppercase">(etc)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fw-semibold mb-0">+14.99%<span class="text-muted ms-2 fs-13 text-uppercase">(usdt)</span></p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fw-medium mb-0">-05.07%<span class="text-muted ms-2 fs-13 text-uppercase">(neo)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                                        <div class="apex-charts crypto-widget" data-colors='["--vz-danger", "--vz-transparent"]' id="neo_sparkline_charts" dir="ltr"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row -->
                                            </div><!-- end card body -->
                                        </div><!-- end card -->
                                        ...
                                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>$48,568.025</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>5.26</h6>
                                                    </td>
                                                    <td>$53,914.025</td>
                                                    <td>1.25634801</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                </tr><!-- end -->
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <td>$87,142.027</td>
                                                    <td>
                                                        <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>3.07</h6>
                                                    </td>
                                                    <td>$75,854.127</td>
                                                    <td>2.85472161</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$33,847.961</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>7.13</h6>
                                                    </td>
                                                    <td>$44,152.185</td>
                                                    <td>1.45612347</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$73,654.421</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.97</h6>
                                                    </td>
                                                    <td>$48,367.125</td>
                                                    <td>0.35734601</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$66,742.077</td>
                                                    <td>
                                                        <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>1.08 </h6>
                                                    </td>
                                                    <td>$53,487.083</td>
                                                    <td>3.62912570</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$34,736.209</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>4.52</h6>
                                                    </td>
                                                    <td>$15,203.347</td>
                                                    <td>1.85412740</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$56,357.313</td>
                                                    <td>
                                                        <h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>2.87</h6>
                                                    </td>
                                                    <td>$61,843.173</td>
                                                    <td>1.87732061</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$62,357.649</td>
                                                    <td>
                                                        <h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.45</h6>
                                                    </td>
                                                    <td>$54,843.173</td>
                                                    <td>0.95632087</td>
                                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">Transaction Fees<span class="text-muted ms-1 fs-13">(0.05%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="mb-0">Minimum Received<span class="text-muted ms-1 fs-13">(2%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                            ...
                            <div class="card card-height-100">
                                ...
                                <div class="card-body p-0">
                                    <div data-simplebar style="height: 390px;">
                                        <div class="p-3">
                                            <h6 class="text-muted text-uppercase mb-3 fs-12">25 Dec 2021</h6>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="fs-15 mb-1">Bought Bitcoin</h6>
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="fs-15 mb-1">Sent Eathereum</h6>
                                                    <p class="text-muted fs-13 mb-0">
                                            ...
                                            <h6 class="text-muted text-uppercase mb-3 mt-4 fs-12">24 Dec 2021</h6>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0">
                                                    <span class="avatar-title bg-light rounded-circle">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="fs-15 mb-1">Sell Dash</h6>
                                                    <p class="text-muted fs-13 mb-0">
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="fs-15 mb-1">Sell Dogecoin</h6>
                                                    <p class="text-muted fs-13 mb-0">
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="fs-15 mb-1">Bought Litecoin</h6>
                                                    <p class="text-muted fs-13 mb-0">
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush border-dashed mb-0">
                                        <li class="list-group-item d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1">Bitcoin</h6>
                                                <p class="text-muted mb-0">$18.7 Billions</p>
                                            </div>
                                            <div class="flex-shrink-0 text-end">
                                                <h6 class="fs-15 mb-1">$12,863.08</h6>
                                                <p class="text-success fs-13 mb-0">+$67.21 (+4.33%)</p>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/assets/images/svg/crypto-icons/eth.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1">Eathereum</h6>
                                                <p class="text-muted mb-0">$27.4 Billions</p>
                                            </div>
                                            <div class="flex-shrink-0 text-end">
                                                <h6 class="fs-15 mb-1">$08,256.04</h6>
                                                <p class="text-success fs-13 mb-0">+$51.19<span class="ms-1">(+5.64%)</span></p>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/assets/images/svg/crypto-icons/aave.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1">Avalanche</h6>
                                                <p class="text-muted mb-0">$12.9 Billions</p>
                                            </div>
                                            <div class="flex-shrink-0 text-end">
                                                <h6 class="fs-15 mb-1">$11,896.13</h6>
                                                <p class="text-danger fs-13 mb-0">-$59.01<span class="ms-1">(-4.08%)</span></p>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/assets/images/svg/crypto-icons/doge.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1">Dogecoin</h6>
                                                <p class="text-muted mb-0">$09.5 Billions</p>
                                            </div>
                                            <div class="flex-shrink-0 text-end">
                                                <h6 class="fs-15 mb-1">$15,999.06</h6>
                                                <p class="text-success fs-13 mb-0">+$74.05<span class="ms-1">(+3.12%)</span></p>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/assets/images/svg/crypto-icons/bnb.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1">Binance</h6>
                                                <p class="text-muted mb-0">$14.2 Billions</p>
                                            </div>
                                            <div class="flex-shrink-0 text-end">
                                                <h6 class="fs-15 mb-1">$13,786.18</h6>
                                                <p class="text-danger fs-13 mb-0">-$61.05<span class="ms-1">(-9.22%)</span></p>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="/assets/images/svg/crypto-icons/ltc.svg" class="avatar-xs" alt="">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1">Litecoin</h6>
                                                <p class="text-muted mb-0">$09.5 Billions</p>
                                            </div>
                                            <div class="flex-shrink-0 text-end">
                                                <h6 class="fs-15 mb-1">$10,604.27</h6>
                                                <p class="text-success fs-13 mb-0">+$76.12<span class="ms-1">(+4.92%)</span></p>
                                            </div>
                                        </li><!-- end -->
                                    </ul><!-- end ul -->
                                </div><!-- end card body -->
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-middle">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted fs-13 mb-0">Dec 12, 2021 <i class="mdi mdi-circle-medium align-middle mx-1"></i>09:22 AM</p>
                                        </div>
                                    </div><!-- end -->
                                    <div class="d-flex mt-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted fs-13 mb-0">Dec 03, 2021 <i class="mdi mdi-circle-medium align-middle mx-1"></i>12:09 PM</p>
                                        </div>
                                    </div><!-- end -->
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="/assets/images/small/img-3.jpg" class="rounded img-fluid" style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1 lh-base"><a href="#" class="text-reset">The bitcoin-holding U.S. senator is trying to “fully integrate” crypto </a></h6>
                                            <p class="text-muted fs-13 mb-0">Nov 22, 2021 <i class="mdi mdi-circle-medium align-middle mx-1"></i>11:47 AM</p>
                                        </div>
                                    </div><!-- end -->
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="/assets/images/small/img-6.jpg" class="rounded img-fluid" style="height: 60px;" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1 lh-base"><a href="#" class="text-reset">Cryptocurrency price like Bitcoin, Dash, Dogecoin, Ripple and Litecoin</a></h6>
                                            <p class="text-muted fs-13 mb-0">Nov 18, 2021 <i class="mdi mdi-circle-medium align-middle mx-1"></i>06:13 PM</p>
                                        </div>
                                    </div><!-- end -->
