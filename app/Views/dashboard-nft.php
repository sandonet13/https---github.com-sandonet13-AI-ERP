...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'NFT Dashboard')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Dashboards', 'title' => 'NFT Dashboard')); ?>
                                    ...
                                    <div class="card overflow-hidden">
                                        <div class="card-body bg-marketplace d-flex">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-18 lh-base fw-bold mb-0">Discover, Collect, Sell and Create <br> your own <span class="text-success">NFTs.</span> </h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">Walking On Air</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">Filtered Portrait</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card explore-box card-animate rounded">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <h5 class="mb-1"><a href="apps-nft-item-details" class="link-dark">Patterns Arts & Culture</a></h5>
                                                <p class="text-muted mb-0">Artwork</p>
                                            </div>
                                            <div class="card-footer border-top border-top-dashed">
                                                <div class="d-flex align-items-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="me-2">
                                                                <img src="/assets/images/nft/gif/img-5.gif" alt="" class="avatar-xs rounded-circle">
                                                            </div>
                                                            <div class="flex-grow-1">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="/assets/images/nft/img-03.jpg" alt="" height="220" class="object-cover w-100" />
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="/assets/images/nft/img-04.jpg" alt="" height="220" class="object-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="/assets/images/nft/gif/img-5.gif" alt="" height="220" class="object-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="dash-collection overflow-hidden rounded-top position-relative">
                                                    <img src="/assets/images/nft/img-06.jpg" alt="" height="220" class="object-cover w-100" />
                                                    <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <a href="#!">
