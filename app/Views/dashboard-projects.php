        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Dashboards', 'title' => 'Projects')); ?>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <p class="text-uppercase fw-semibold text-truncate text-muted mb-3">New Leads</p>
                                                    <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0 pb-2">
                                            <div>
                                                <div id="projects-overview-chart" data-colors='["--vz-secondary", "--vz-warning", "--vz-success"]' class="apex-charts" dir="ltr"></div>
                                            </div>
                                        </div><!-- end card body -->
                                    </div><!-- end card -->
                                </div><!-- end col -->
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                            ...
                                            <div>
                                                ...
                                                <span class="text-success fw-semibold fs-13">15870hrs</span>
                                            </div>
                                        </div><!-- end -->
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <span class="text-success fw-semibold fs-13">243hrs</span>
                                            </div>
                                        </div><!-- end -->
                                        <div class="d-flex justify-content-between border-bottom border-bottom-dashed py-2">
                                            ...
                                            <div>
                                                ...
                                                <span class="text-success fw-semibold fs-13">~2050hrs</span>
                                            </div>
                                        </div><!-- end -->
                                        <div class="d-flex justify-content-between py-2">
                                            ...
                                            <div>
                                                ...
                                                <span class="text-success fw-semibold fs-13">~900hrs</span>
                                            </div>
                                        </div><!-- end -->
                                    </div>
                                </div><!-- end cardbody -->
