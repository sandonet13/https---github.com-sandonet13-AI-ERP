        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Forms', 'title' => 'Form Select')); ?>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div>
                                        <div>
                                            <h5 class="fs-15 mb-3">Single select input Example</h5>
                                        ...
                                        <div class="mt-4">
                                            <h5 class="fs-15 mb-3">Multiple select input</h5>
                                        ...
                                        <div class="mt-4">
                                            <h5 class="fs-15 mb-3">Text inputs</h5>
