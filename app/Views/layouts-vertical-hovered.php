                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-6">
                                                            <div class="d-flex flex-wrap gap-4 align-items-center">
                                                                ...
                                                                <p class="fw-semibold text-muted mb-0">$75.69 <span class="text-success fs-12 ms-1">+1.99%</span></p>
                                                                <p class="fw-semibold text-muted mb-0">High <spanclass="text-dark fs-12 ms-1">0.014578</span></p>
                                                                <p class="fw-semibold text-muted mb-0">Low <span class="text-dark fs-12 ms-1">0.0175489</span></p>
                                                            </div>
                                                        </div><!-- end col -->
                                                        <div class="col-6">
                                                            <div class="d-flex">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fs-14 fw-semibold mb-0">
															+13.11%<span class="text-muted ms-2 fs-12 text-uppercase">(btc)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fs-14 fw-semibold mb-0">
															+15.08%<span class="text-muted ms-2 fs-12 text-uppercase">(ltc)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fs-14 fw-medium mb-0">
                                                            +08.57%<span class="text-muted ms-2 fs-12 text-uppercase">(etc)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                                        <div class="apex-charts crypto-widget" data-colors='["--vz-success", "--vz-transparent"]' id="eathereum_sparkline_charts" dir="ltr"></div>
                                                    </div><!-- end col -->
                                                </div><!-- end row -->
                                            </div><!-- end card body -->
                                        </div><!-- end card -->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fs-14 fw-semibold mb-0">
															-09.21%<span class="text-muted ms-2 fs-12 text-uppercase">(bnb)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fs-14 fw-semibold mb-0">
															+12.07%<span class="text-muted ms-2 fs-12 text-uppercase">(dash)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-success fs-14 fw-medium mb-0">
                                                            +14.99%<span class="text-muted ms-2 fs-12 text-uppercase">(usdt)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row align-items-end g-0">
                                                    <div class="col-6">
                                                        ...
                                                        <p class="text-danger fs-14 fw-semibold mb-0">
															-05.07%<span class="text-muted ms-2 fs-12 text-uppercase">(neo)</span>
                                                        </p>
                                                    </div><!-- end col -->
                                                    <div class="col-6">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h6 class="fs-15 mb-0">Bitcoin</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>$48,568.025</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h6 class="fs-15 mb-0">Litecoin</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>$87,142.027</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h6 class="fs-15 mb-0">Eathereum</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>$33,847.961</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h6 class="fs-15 mb-0">Binance</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>$73,654.421</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <h6 class="fs-15 mb-0">Dogecoin</h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>$62,357.649</td>
                                        ...
                                        <div class="tab-pane active" id="buy-tab" role="tabpanel">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3 pt-2">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="fs-14 mb-0">Estimated Rate</p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="tab-pane" id="sell-tab" role="tabpanel">
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="mt-3 pt-2">
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="fs-14 mb-0">Transaction Fees<span class="text-muted ms-1 fs-11">(0.05%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                            <h6 class="mb-0">$1.08</h6>
                                                        </div>
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <div class="flex-grow-1">
                                                            <p class="fs-14 mb-0">Minimum Received<span class="text-muted ms-1 fs-11">(2%)</span></p>
                                                        </div>
                                                        <div class="flex-shrink-0">
                                                            <h6 class="mb-0">$7.85</h6>
                                                        </div>
