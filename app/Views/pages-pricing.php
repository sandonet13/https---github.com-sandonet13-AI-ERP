...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Pricing')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Pages', 'title' => 'Pricing')); ?>

                    <div class="row justify-content-center mt-4">
                        <div class="col-lg-5">
                            <div class="text-center mb-4">
                                <h4 class="fw-bold fs-22">Plans & Pricing</h4>
                                ...
                                <div class="card-body bg-light m-2 p-4">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="flex-grow-1">
                                            <h5 class="mb-0 fw-bold">Starter</h5>
                                        </div>
                                        <div class="ms-auto">
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card pricing-box">
                                <div class="card-body bg-light m-2 p-4">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="flex-grow-1">
                                            <h5 class="mb-0 fw-bold">Professional</h5>
                                        </div>
                                        <div class="ms-auto">
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card pricing-box ribbon-box right">
                                <div class="card-body bg-light m-2 p-4">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="flex-grow-1">
                                            <h5 class="mb-0 fw-bold">Enterprise</h5>
                                        </div>
                                        <div class="ms-auto">
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card pricing-box">
                                <div class="card-body bg-light m-2 p-4">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="flex-grow-1">
                                            <h5 class="mb-0 fw-bold">Unlimited</h5>
                                        </div>
                                        <div class="ms-auto">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-lg-5">
                            <div class="text-center mb-4 pb-2">
                                <h4 class="fw-bold fs-22">Choose the plan that's right for you</h4>
                                <p class="text-muted mb-4 fs-15">Simple pricing. No hidden fees. Advanced features for you business.</p>
                            </div>
                        </div>
                        <!--end col-->
                                ...
                                <div class="col-lg-4">
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div class="pt-4">
                                                <h2><sup><small>$</small></sup>19 <span class="fs-14 text-muted">/Month</span></h2>
                                            </div>
                                    ...
                                    <div class="card pricing-box ribbon-box right">
                                        <div class="card-body p-4 m-2">
                                            ...
                                            <div>
                                                ...
                                                <div class="pt-4">
                                                    <h2><sup><small>$</small></sup> 29<span class="fs-14 text-muted">/Month</span></h2>
                                                </div>
                                            </div>
                                            <hr class="my-4 text-muted">
                                            <div>
                                    ...
                                    <div class="card pricing-box">
                                        <div class="card-body p-4 m-2">
                                            <div>
                                                ...
                                                <div class="pt-4">
                                                    <h2><sup><small>$</small></sup> 39<span class="fs-14 text-muted">/Month</span></h2>
                                                </div>
                                            </div>
                                            <hr class="my-4 text-muted">
                                            <div>
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-lg-4">
                            <div class="text-center mb-4 pb-2">
                                <h4 class="fw-bold fs-22">Simple Pricing Plan</h4>
                                <p class="text-muted mb-4 fs-15">Simple pricing. No hidden fees. Advanced features for you business.</p>
