...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Search Results')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Pages', 'title' => 'Search Results')); ?>
                            ...
                            <div class="card">
                                <div class="card-header border-0">
                                    <div class="row justify-content-center mb-4">
                                        ...
                                        <!--end col-->
                                        <div class="col-lg-12">
                                            <h5 class="fs-16 fw-bold text-center mb-0">Showing results for "<span class="text-primary fw-semibold fst-italic">Admin Dashboard</span> "</h5>
                                        </div>
                                    </div>
                                    <!--end row-->
                                                            ...
                                                            <div class="d-sm-flex">
                                                                ...
                                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                    <ul class="list-inline mb-2">
                                                                        <li class="list-inline-item"><span class="badge badge-soft-success fs-12">Business</span></li>
                                                                    </ul>
