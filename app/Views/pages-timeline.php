...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Timeline')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Pages', 'title' => 'Timeline')); ?>
                                            ...
                                            <div class="col-12">
                                                <div class="timeline-box">
                                                    <div class="timeline-text">
                                                        ...
                                                        <div class="row border border-dashed rounded gx-2 p-2">
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/assets/images/small/img-7.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/assets/images/small/img-3.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/assets/images/small/img-10.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-3">
                                                                <a href="javascript:void(0);"><img src="/assets/images/small/img-9.jpg" alt="" class="img-fluid rounded"></a>
                                                            </div>
                                                            <!--end col-->
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card pt-2 border-0 item-box text-center">
                                                    <div class="timeline-content p-3 rounded">
                                                        <div>
                                                            <p class="text-muted mb-0">December, 2020</p>
