...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Listjs')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Tables', 'title' => 'Listjs')); ?>
                                        ...
                                        <div data-simplebar style="height: 242px;" class="mx-n3">
                                            <ul class="list list-group list-group-flush mb-0">
                                                <li class="list-group-item" data-id="1">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Jonny Stromberg</a></h5>
                                                ...
                                                <li class="list-group-item" data-id="2">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Jonas Arnklint</a></h5>
                                                ...
                                                <li class="list-group-item" data-id="3">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Martina Elm</a></h5>
                                                ...
                                                <li class="list-group-item" data-id="4">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <h5 class="fs-14 mb-1"><a href="#" class="link name text-dark">Gustaf Lindqvist</a></h5>
                                            ...
                                            <ul class="list list-group list-group-flush mb-0">
                                                <li class="list-group-item" data-id="01">
                                                    <div class="d-flex align-items-start">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Jonny Stromberg</a></h5>
                                                            <p class="contact-born text-muted mb-0">New updates for ABC Theme</p>
                                                        </div>

                                                        <div class="flex-shrink-0 ms-2">
                                                            <div class="fs-12 text-muted">06 min</div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <!-- end list item -->
                                                <li class="list-group-item" data-id="02">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Jonas Arnklint</a></h5>
                                                            <p class="contact-born text-muted mb-0">Bug Report - abc theme</p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                            <div class="fs-12 text-muted">12 min</div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <!-- end list item -->
                                                <li class="list-group-item" data-id="03">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Martina Elm</a></h5>
                                                            <p class="contact-born text-muted mb-0">Nice to meet you</p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                            <div class="fs-12 text-muted">28 min</div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <!-- end list item -->
                                                <li class="list-group-item" data-id="04">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="contact-name fs-14 mb-1"><a href="#" class="link text-dark">Gustaf Lindqvist</a></h5>
                                                            <p class="contact-born text-muted mb-0">I've finished it! See you so</p>
                                                        </div>
                                                        <div class="flex-shrink-0 ms-2">
                                                            <div class="fs-12 text-muted">01 hrs</div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <!-- end list item -->
