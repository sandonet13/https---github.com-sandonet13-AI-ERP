        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Base UI', 'title' => 'Cards')); ?>
                            ...
                            <div class="row">
                                <div class="col-xxl-6">
                                    <div class="card">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img class="rounded-start img-fluid h-100 object-cover" src="/assets/images/small/img-12.jpg" alt="Card image">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-header">
                                ...
                                <div class="col-xxl-6">
                                    <div class="card">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-4">
                                                <img class="rounded-end img-fluid h-100 object-cover" src="/assets/images/small/img-4.jpg" alt="Card image">
                                            </div>
                                        </div>
                                    </div><!-- end card -->
                                </div><!-- end col -->
                                ...
                                <div class="col-xxl-6">
                                    <div class="card">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img class="rounded-start img-fluid h-100 object-cover" src="/assets/images/small/img-9.jpg" alt="Card image">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
