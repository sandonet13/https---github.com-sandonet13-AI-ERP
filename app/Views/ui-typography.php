...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Typography')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Base UI', 'title' => 'Typography')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="text-muted">
                                                    ...
                                                    <div>
                                                        <p class="display-4 text-dark fw-semibold">Aa</p>
                                                    </div>
                                                    <div>
                                                        <p class="mb-2">Font Family</p>
                                                        <h5 class="mb-0">'Nunito', sans-serif</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="text-muted mt-4 mt-sm-0">
                                                    ...
                                                    <div>
                                                        <h1 class="display-4 text-dark fw-semibold">Aa</h1>
                                                    </div>
                                                    <div>
                                                        <p class="mb-2">Font Family</p>
                                                        <h5 class="mb-0">'Nunito', sans-serif</h5>
