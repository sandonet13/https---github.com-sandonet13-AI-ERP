...
<head>
    ...
    <?php echo view('partials/title-meta', array('title' => 'Utilities')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Base UI', 'title' => 'Utilities')); ?>
                                        ...
                                        <div>
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>font-family: 'Nunito', sans-serif;</td>
