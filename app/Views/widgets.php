        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php echo view('partials/page-title', array('pagetitle' => 'Velzon', 'title' => 'Widgets')); ?>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <p class="text-uppercase fw-semibold text-muted mb-0">Total Earnings</p>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-bold ff-secondary mb-4">$<span class="counter-value" data-target="559.25">0</span>k</h4>
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="card card-animate bg-info">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <p class="text-uppercase fw-semibold text-white-50 mb-0">Orders</p>
                                        </div>
                                        <div class="flex-shrink-0">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-bold ff-secondary mb-4 text-white"><span class="counter-value" data-target="36894">0</span></h4>
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <p class="text-uppercase fw-semibold text-muted mb-0">Customers</p>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <h5 class="text-success fs-14 mb-0">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-bold ff-secondary mb-4"><span class="counter-value" data-target="183.35">0</span>M</h4>
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <p class="text-uppercase fw-semibold text-muted mb-0">My Balance</p>
                                        </div>
                                        <div class="flex-shrink-0">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-bold ff-secondary mb-4">$<span class="counter-value" data-target="165.89">0</span>k</h4>
                                ...
                                <div class="card-body p-0">
                                    <div class="row row-cols-md-3 row-cols-1">
                                        <div class="col col-lg border-end">
                                            <div class="py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-14">Campaign Sent <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i>
                                                </h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="col col-lg border-end">
                                            <div class="mt-3 mt-md-0 py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-14">Annual Profit <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h2 class="mt-4 ff-secondary fw-bold"><span class="counter-value" data-target="28.05">0</span>k</h2>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h2 class="mt-4 ff-secondary fw-bold"><span class="counter-value" data-target="97.66">0</span>k</h2>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-animate bg-primary">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <p class="fw-semibold text-white-50 mb-0">Avg. Visit Duration</p>
                                            <h2 class="mt-4 ff-secondary fw-bold text-white"><span class="counter-value" data-target="3">0</span>m <span class="counter-value" data-target="40">0</span>sec</h2>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h2 class="mt-4 ff-secondary fw-bold"><span class="counter-value" data-target="33.48">0</span>%</h2>
                            ...
                            <div class="card bg-success card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-semibold text-white-50 mb-3">Total Sales</p>
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-semibold text-muted mb-3">Number of Users</p>
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-semibold text-muted mb-3">Total Revenue</p>
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <p class="text-uppercase fw-semibold text-muted mb-3">Number of Stores</p>
                            ...
                            <div class="card bg-primary">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-sm-8">
                                            <div class="p-3">
                                                <p class="fs-16 lh-base text-white">Upgrade your plan from a <span class="fw-bold">Free trial</span>, to ‘Premium Plan’ <i class="mdi mdi-arrow-right"></i></p>
                                                <div class="mt-3">
                                                    <a href="pages-pricing" class="btn btn-info">Upgrade Account!</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="pages-pricing" class="text-reset text-decoration-underline"><b>Get Free Gift</b></a>
                                        </div>
                                    </div>
                                    <div class="d-flex p-3">
                                        ...
                                        <div>
                                            <p class="fs-16 lh-base">Personalized <span class="fw-bold">Gift Boxes</span>, with attitude, Let's collect your Xmas box <i class="mdi mdi-arrow-right"></i></p>
                                            <div class="mt-3">
                                                <a href="pages-pricing" class="btn btn-secondary">Get a Free Gift</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end card-body-->
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="fs-16 fw-bold">Brand Logo Design - MD</h5>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="fs-16 fw-bold">Redesign - Landing Page</h5>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="fs-16 fw-bold">Ecommerce App for Web</h5>
                                        ...
                                        <li class="list-group-item ps-0">
                                            <div class="row align-items-center g-3">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <a href="#" class="text-reset fs-15 mb-0">Meeting for campaign with sales team</a>
                                                </div>
                                    ...
                                    <div class="card card-height-100">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="align-items-center p-3 justify-content-between d-flex">
                                                <div class="flex-shrink-0">
                                                    <div class="text-muted"><span class="fw-bold">4</span> of <span class="fw-bold">10</span> remaining</div>
                                                </div>
                                                    ...
                                                    <li class="list-group-item ps-0">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-shrink-0 ms-2">
                                                                <p class="text-muted fs-13 mb-0">15 Sep, 2021</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item ps-0">
                                            ...
                                            <div data-simplebar style="max-height: 364px;" class="p-3">
                                                <div class="acitivity-timeline acitivity-main">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-1">Added new <span class="fw-bold">style collection</span></h6>
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            <h6 class="mb-1">Today offers by <a href="apps-ecommerce-seller-details" class="link-secondary">Digitech Galaxy</a></h6>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-shrink-0 text-end">
                                                    ...
                                                    <p class="text-success fs-14 mb-0">$19,405.12</p>
                                                </div>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-shrink-0 text-end">
                                                    ...
                                                    <p class="text-danger fs-14 mb-0">$40552.18</p>
                                                </div>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-shrink-0 text-end">
                                                    ...
                                                    <p class="text-success fs-14 mb-0">$15824.58</p>
                                                </div>
                                            </div>
                                        </li><!-- end -->
                                        <li class="list-group-item px-0 pb-0">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-shrink-0 text-end">
                                                    ...
                                                    <p class="text-success fs-14 mb-0">$30635.84</p>
                                                </div>
                                            </div>
                                        </li><!-- end -->
                                    </ul><!-- end -->
                        ...
                        <div class="col-xxl-4">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="color_heatmap" data-colors='["--vz-info", "--vz-success", "--vz-primary", "--vz-warning", "--vz-secondary"]' class="apex-charts mt-n3" dir="ltr"></div>

                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="d-flex mb-3">
                                                <div class="flex-grow-1">
                                                    <p class="text-truncate text-muted fs-15 mb-0"><i class="mdi mdi-circle align-middle text-primary me-2"></i>www.google.com</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                            ...
                                            <div class="d-flex mb-3">
                                                <div class="flex-grow-1">
                                                    <p class="text-truncate text-muted fs-15 mb-0"><i class="mdi mdi-circle align-middle text-warning me-2"></i>www.medium.com</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <p class="text-truncate text-muted fs-15 mb-0"><i class="mdi mdi-circle align-middle text-secondary me-2"></i>Other</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex mb-3">
                                                <div class="flex-grow-1">
                                                    <p class="text-truncate text-muted fs-15 mb-0"><i class="mdi mdi-circle align-middle text-info me-2"></i>www.youtube.com</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                            ...
                                            <div class="d-flex mb-3">
                                                <div class="flex-grow-1">
                                                    <p class="text-truncate text-muted fs-15 mb-0"><i class="mdi mdi-circle align-middle text-success me-2"></i>www.meta.com</p>
                                                </div>
                                                <div class="flex-shrink-0">
