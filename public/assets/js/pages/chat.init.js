...
Array.from(document.querySelectorAll(".chat-user-list li a")).forEach(function (item) {
    item.addEventListener("click", function (event) {
        Array.from(userChatElement).forEach(function (elm) {
...
// user-chat-remove
Array.from(document.querySelectorAll(".user-chat-remove")).forEach(function (item) {
    item.addEventListener("click", function (event) {
        Array.from(userChatElement).forEach(function (elm) {
...
Array.from(document.querySelectorAll("#userList li")).forEach(function (item) {
...
Array.from(document.querySelectorAll("#channelList li")).forEach(function (item) {
    item.addEventListener("click", function () {
...
Array.from(copyMessage).forEach(function (item) {
    item.addEventListener("click", function () {
...
Array.from(copyClipboardAlert).forEach(function (item) {
    item.addEventListener("click", function () {
...
Array.from(deleteItems).forEach(function (item) {
    item.addEventListener("click", function () {
...
Array.from(deleteImage).forEach(function (item) {
    Array.from(item.querySelectorAll(".delete-image")).forEach(function (subitem) {
...
Array.from(replyMessage).forEach(function (item) {
    item.addEventListener("click", function () {
        isreplyMessage = true;
...
var getChatList = function (chatid, chatItems) {
    ...
    Array.from(newChatList.querySelectorAll(".delete-item")).forEach(function (subitem) {
        subitem.addEventListener("click", function () {
    ...
    //Copy Message
    Array.from(newChatList.querySelectorAll(".copy-message")).forEach(function (subitem) {
        subitem.addEventListener("click", function () {
            var currentValue =
    ...
    //reply Message model    
    Array.from(newChatList.querySelectorAll(".reply-message")).forEach(function (subitem) {
        subitem.addEventListener("click", function () {
