...
function getChartColorsArray(chartId) {
  ...
  var donutchartportfolioColors = getChartColorsArray("portfolio_donut_charts1");
  if (donutchartportfolioColors) {
    ...
    var chart = new ApexCharts(document.querySelector("#portfolio_donut_charts1"), options);
    chart.render();
  }
    ...
    // Total Portfolio Donut Charts
    var donutchartportfolioColors = getChartColorsArray("portfolio_donut_charts3");
    if (donutchartportfolioColors) {
      var options = {
        series: [19405, 40552, 15824, 30635],
        labels: ["Bitcoin", "Ethereum", "Litecoin", "Dash"],
      ...
      var chart = new ApexCharts(document.querySelector("#portfolio_donut_charts3"), options);
      chart.render();
    }

    // Total Portfolio Donut Charts
    var donutchartportfolioColors = getChartColorsArray("portfolio_donut_charts4");
    if (donutchartportfolioColors) {
      var options = {
        series: [19405, 40552, 15824, 30635],
        labels: ["Bitcoin", "Ethereum", "Litecoin", "Dash"],
      ...
      var chart = new ApexCharts(document.querySelector("#portfolio_donut_charts4"), options);
      chart.render();
    }
