...
if (chartBarLabelRotationColors) {
...
// Simple Gauge
var chartGaugeColors = getChartColorsArray("chart-gauge-2");
if (chartGaugeColors) {
    var chartDom = document.getElementById('chart-gauge-2');
    var myChart = echarts.init(chartDom);
    var option;
...
// Simple Gauge
var chartGaugeColors = getChartColorsArray("chart-gauge-3");
if (chartGaugeColors) {
    var chartDom = document.getElementById('chart-gauge-3');
    var myChart = echarts.init(chartDom);
    var option;
...
// Simple Gauge
var chartGaugeColors = getChartColorsArray("chart-gauge-4");
if (chartGaugeColors) {
    var chartDom = document.getElementById('chart-gauge-4');
    var myChart = echarts.init(chartDom);
    var option;
